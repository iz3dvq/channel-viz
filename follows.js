(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'pM7TBzZMsxvl1IxRUqV9VRKryviSAKxmajcxZFJvRmx3bz0g', // Unique master Xively API key to be used as a default
		defaultFeeds	= [91180], // Comma separated array of Xively Feed ID numbers
		applicationName	= '', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= 'DC143C', // CSS HEX value of color to represent data (omit leading #)
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var graph = new Rickshaw.Graph( {
										...
										height: 200,
										renderer: 'area',
										min: parseFloat(datastream.min_value) - .15*(parseFloat(datastream.max_value) - parseFloat(datastream.min_value)),
										max: parseFloat(datastream.max_value) + .15*(parseFloat(datastream.max_value) - parseFloat(datastream.min_value)),
										padding: {
											top: 0.02,
											right: 0.02,
											bottom: 0.02,
